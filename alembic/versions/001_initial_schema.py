...
def upgrade() -> None:
    ...
    op.create_table(
        "storeys",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("project_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("ifc_projects.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("project_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("ifc_projects.id", ondelete="CASCADE"), nullable=False),
        sa.Column("storey_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("storeys.id", ondelete="SET NULL"), nullable=True),
        sa.Column("type_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("element_types.id", ondelete="SET NULL"), nullable=True),
        sa.Column("global_id", sa.String(22), nullable=False),
        sa.Column("ifc_class", sa.String(100), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("project_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("ifc_projects.id", ondelete="CASCADE"), nullable=False),
        sa.Column("storey_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("storeys.id", ondelete="SET NULL"), nullable=True),
        sa.Column("element_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("building_elements.id", ondelete="CASCADE"), nullable=False),
        sa.Column("global_id", sa.String(22), nullable=False),
        sa.Column("name", sa.String(255), nullable=True),
        sa.Column("long_name", sa.String(255), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("element_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("building_elements.id", ondelete="CASCADE"), nullable=False),
        sa.Column("pset_definition_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("property_set_definitions.id", ondelete="CASCADE"), nullable=False),
        ...
        sa.UniqueConstraint("element_id", "pset_definition_id", "property_name", name="props_uk_element_pset_prop"),
    )
    ...
    op.create_table(
        "type_properties",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("type_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("element_types.id", ondelete="CASCADE"), nullable=False),
        sa.Column("pset_definition_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("property_set_definitions.id", ondelete="CASCADE"), nullable=False),
        sa.Column("property_name", sa.String(255), nullable=False),
        sa.Column("property_value", sa.Text, nullable=True),
        sa.Column("data_type", sa.String(20), server_default="string", nullable=False),
        sa.Column("unit", sa.String(50), nullable=True),
        sa.UniqueConstraint("type_id", "pset_definition_id", "property_name", name="type_props_uk"),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("element_id", "qto_name", "quantity_name", name="qtos_uk_element_qto_qty"),
    )
    ...
    op.create_table(
        "element_openings",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("host_element_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("building_elements.id", ondelete="CASCADE"), nullable=False),
        sa.Column("filling_element_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("building_elements.id", ondelete="CASCADE"), nullable=False),
        sa.UniqueConstraint("host_element_id", "filling_element_id", name="openings_uk"),
    )
